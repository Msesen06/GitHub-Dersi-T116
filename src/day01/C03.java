...
public class C03 {
    public static void main(String[] args) {
        ...
        2- git log --oneline diyerek projenin tum gecmisini gosterin
        3- isteginiz commite gitmek icin git checkout 123456
        istenen commitin hash kodunun ilk 6 hanesi
